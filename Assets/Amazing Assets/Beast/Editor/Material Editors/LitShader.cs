...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class BeastLitShader : BaseShaderGUI
    {
        ...
        //Beast
        private SavedBool m_BeastInputsFoldout;
        ...
        public override void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            //Beast
            m_BeastInputsFoldout = new SavedBool($"{headerStateKey}.BeastInputsFoldout", true);
        }
        ...
        public override void DrawAdditionalFoldouts(Material material)
        {
            ...
            m_BeastInputsFoldout.value = EditorGUILayout.BeginFoldoutHeaderGroup(m_BeastInputsFoldout.value, "Beast Tessellation");
            if (m_BeastInputsFoldout.value)
            {
